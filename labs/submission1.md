...
Автозаполненик PR удобно, так как позволяет отструктурировать информацию, всё кратко и чётко. При этом у всех одинаковая структура запросов.
### Скриншот автозаполнения:
...
Только осваиваюсь, поэтому появлялись трудности в виде непонимания, когда комитить и пушить. Поэтому не получалось автозаполнение вначале.
